      ...
      <section className="relative isolate min-h-screen">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <Image
            ...
            fill
            priority
            className="hero-image animate-[slowZoom_18s_ease-in-out_infinite] object-cover object-center opacity-45"
          />
        ...
        {/* Main container */}
        <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-between px-6 py-7 md:px-10 lg:px-14">
          {/* Header */}
          ...
          {/* Hero */}
          <div className="grid flex-1 items-center gap-14 py-14 lg:grid-cols-[1.08fr_0.92fr] lg:gap-20 lg:py-20">
            {/* Left */}
            <div className="max-w-3xl">
              ...
              <p className="animate-[fadeUp_1.5s_ease-out] mt-7 max-w-xl text-sm leading-8 text-white/58 md:text-[15px]">
              ...
              {/* CTA */}
              <div className="animate-[fadeUp_1.7s_ease-out] mt-10 flex flex-wrap items-center gap-4">
                <Link
                  href="/dashboard"
            ...
            {/* Right Card */}
            <div className="relative animate-[floatCard_9s_ease-in-out_infinite]">
              {/* glow */}
              ...
              <div className="deal-card relative rounded-[30px] border border-white/10 bg-white/[0.045] p-[1px] shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl transition-all duration-700 hover:translate-y-[-3px] hover:border-white/15">
                <div className="rounded-[30px] bg-[linear-gradient(to_bottom,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-6">
                  {/* top */}
          ...
          {/* Footer */}
          <footer className="animate-[fadeUp_2s_ease-out] flex flex-wrap items-center justify-between gap-4 border-t border-white/10 pt-5 text-[10px] uppercase tracking-[0.28em] text-white/32">
            <div className="flex items-center gap-3">
